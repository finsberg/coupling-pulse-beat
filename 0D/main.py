"""Run only 0D simulations but with splitting of the mechanics and electrophysiology models
and testing different tolerances for when to solve the mechanics
"""
